        ...
        for (let block of message) {
            ...
            if (!hasUnicode && block.length <= 1) {
                ...
                if (packetType == 'u') {
                    ...
                    console.error(`It's advised to count forwards or backwards from the easily discernable values of 65535 for health fraction and #ffffff (or another color hexcode) for names.\n`);
                }
